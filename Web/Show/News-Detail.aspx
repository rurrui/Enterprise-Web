<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News-Detail.aspx.cs" Inherits="SJD.Web.Show.News_Detail" %>
                ...
                <div class="nav_wd">
                    <div class="h_navlist1" id="a">
                        <ul>
                            ...
                            <li style="position: relative;"><a href="channel.php.htm" tppabs="http://www.koal.com/koal_main/channel.php" class=''>渠道合作</a>
                                <div class="hidden_nav-s">
                                    <div class="hidden_top"></div>
                                    <dl>

                                        <dd>
                                            <a href="channel.php.htm" tppabs="http://www.koal.com/koal_main/channel.php">渠道与合作</a>
                                        </dd>
                                        <dd>
                                            <a href="channel2.php.htm" tppabs="http://www.koal.com/koal_main/channel2.php">渠道部联系方式</a>
                                        </dd>
                            ...
                            <li style="position: relative;"><a href="support.php.htm" tppabs="http://www.koal.com/koal_main/support.php" class=''>技术支持</a>
                                <div class="hidden_nav-s">
                                    <div class="hidden_top"></div>
                                    <dl>

                                        <dd>
                                            <a href="support.php.htm" tppabs="http://www.koal.com/koal_main/support.php">技术问答</a>
                                        </dd>
                                        <dd>
                                            <a href="service.php.htm" tppabs="http://www.koal.com/koal_main/service.php">客服中心</a>
                                        </dd>
                            ...
                            <li style="background: none !important; position: relative;"><a class='hover_menu' href="com-contact.php.htm">关于公司</a>
                                <div class="hidden_nav-s">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <a href="com-introduction.php.htm" tppabs="http://www.koal.com/koal_main/com-introduction.php">公司介绍</a>
                                        </dd>
                                        <dd>
                                            <a href="news-list.php.htm" tppabs="http://www.koal.com/koal_main/news-list.php">新闻快讯</a>
                                        </dd>
                                        <dd>
                                            <a href="com-meeting.php.htm" tppabs="http://www.koal.com/koal_main/com-meeting.php">公司公告</a>
                                        </dd>
                                        <dd>
                                            <a href="com-honer.php.htm" tppabs="http://www.koal.com/koal_main/com-honer.php">资质荣誉</a>
                                        </dd>
                                        <dd>
                                            <a href="com-union.php.htm" tppabs="http://www.koal.com/koal_main/com-union.php">工会活动</a>
                                        </dd>
    ...
    <div class="content-in">
        ...
        <div class="list-r">
            <div class="list-rtit mb10px">
                <a href="index.php.htm" tppabs="http://www.koal.com/koal_main/index.php">首 页</a>
                &nbsp;>&nbsp;
                    <a href="com-contact.php.htm" tppabs="http://www.koal.com/koal_main/com-contact.php">关于公司</a>
                &nbsp;>&nbsp;
