<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="add-recruit.aspx.cs" Inherits="SJD.Web.Admin.add_recruit" %>
                ...
                <div class="span3">
                    <div class="well sidebar-nav" style="margin-top: 50px">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="recruit.aspx">管理</a></li>
                            <li class="active"><a href="add-recruit.aspx">添加</a></li>
                        </ul>
                    </div>
                </div>
                <div class="span9">
