<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="super-add-recruit.aspx.cs" Inherits="SJD.Web.Admin.super_add_recruit" %>
                    ...
                    <div class="well sidebar-nav" style="margin-top: 50px">
                        <ul class="nav nav-list">
                         ...
                         <li class="nav-header"><i class="icon-wrench"></i>用户管理</li>
                            ...
                            <li class="active"><a href="super-add-recruit.aspx">添加</a></li>
                            <li><a href="super-recruit.aspx">管理</a></li>
                        </ul>
                    </div>
                </div>
                <div class="span9">
                    <div class="row-fluid">
                        <div class="page-header">
                            <h1>添加 <small>添加Recruit</small></h1>
                        </div>
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="input-xlarge" id="name" name="rtitle" style="height: 30px" />
                                    </div>
                                </div>

                                <div class="control-group">
                                    <textarea class="layui-textarea" id="LAY_demo1" style="display: none" name="article">  
                                ...
                                <div class="form-actions">
                                    ...
                                    <a class="btn" href="recruit.aspx">取消</a>
                                </div>
                                <br />
