<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="edit-recruit.aspx.cs" Inherits="SJD.Web.Admin.edit_recruit" %>
                ...
                <div class="span3">
                    <div class="well sidebar-nav" style="margin-top: 50px">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="solution.aspx">方案</a></li>
                            <li><a href="add-solution.aspx">添加</a></li>
                            <li class="nav-header"><i class="icon-user"></i>招贤纳士</li>
                            <li class="active"><a href="recruit.aspx">列表</a></li>
                            <li><a href="add-recruit.aspx">添加</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="input-xlarge" id="name" name="ertitle" style="height: 30px" value="<%=Model.RecruitTitle %>""/>
                                    </div>
                                </div>

                                <div class="control-group">
                                    <textarea class="layui-textarea" id="LAY_demo1" style="display: none" name="earticle">  
                                       <%=Model.RecruitContent %>
                                    </textarea>
                                </div>
