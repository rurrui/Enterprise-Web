<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="super-add-news.aspx.cs" Inherits="SJD.Web.Admin.super_add_news" %>
                    ...
                    <div class="well sidebar-nav" style="margin-top: 50px">
                        <ul class="nav nav-list">
                           <li class="nav-header"><i class="icon-wrench"></i>用户管理</li>
                            ...
                            <li class="active"><a href="super-add-news.aspx">添加</a></li>
                            <li><a href="super-news.aspx">管理</a></li>
                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="input-xlarge" id="name" name="ntitle" style="height: 30px" />
                                    </div>
                                </div>

                                <div class="control-group">
                                    <textarea class="layui-textarea" id="LAY_demo1" style="display: none" name="acticle">  
