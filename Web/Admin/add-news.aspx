<%@ Page Language="C#" validateRequest="false" AutoEventWireup="true" CodeBehind="add-news.aspx.cs" Inherits="SJD.Web.Admin.add_news" %>
                ...
                <div class="span3">
                    <div class="well sidebar-nav" style="margin-top:50px">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="Index.aspx">管理</a></li>
                            <li class="active"><a href="add-news.aspx">添加</a></li>
