<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-user.aspx.cs" Inherits="SJD.Web.Admin.add_user" %>
                        ...
                        <form class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="input-xlarge" id="name" name="username" style="height: 30px" />
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" class="input-xlarge" id="upwd" name="pwd"/>
                                    </div>
                                </div>
                                  <div class="control-group">
