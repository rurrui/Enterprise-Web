<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="super-edit-recruit.aspx.cs" Inherits="SJD.Web.Admin.super_edit_recruit" %>
                    ...
                    <div class="well sidebar-nav" style="margin-top: 50px">
                        <ul class="nav nav-list">
                           ...
                           <li class="nav-header"><i class="icon-wrench"></i>用户管理</li>
                            ...
                            <li><a href="super-add-recruit.aspx">添加</a></li>
                            <li class="active"><a href="super-recruit.aspx">管理</a></li>
                        </ul>
                    </div>
                </div>
                <div class="span9">
