...
namespace SJD.DAL
{
	...
	public partial class News
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("NewId", "News"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SJD.Model.News model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into News(");
			strSql.Append("NewTitle,NewContent,NewTime)");
			strSql.Append(" values (");
			strSql.Append("@NewTitle,@NewContent,@NewTime)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@NewTitle", SqlDbType.NVarChar,50),
					new SqlParameter("@NewContent", SqlDbType.Text),
					new SqlParameter("@NewTime", SqlDbType.date,3)};
			parameters[0].Value = model.NewTitle;
			parameters[1].Value = model.NewContent;
			parameters[2].Value = model.NewTime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SJD.Model.News model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[1].Value = model.NewContent;
			parameters[2].Value = model.NewTime;
			parameters[3].Value = model.NewId;
		...
		/// 得到一个对象实体
		/// </summary>
		public SJD.Model.News GetModel(int NewId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 NewId,NewTitle,NewContent,NewTime from News ");
			strSql.Append(" where NewId=@NewId");
			SqlParameter[] parameters = {
					new SqlParameter("@NewId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SJD.Model.News DataRowToModel(DataRow row)
		{
			SJD.Model.News model=new SJD.Model.News();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select NewId,NewTitle,NewContent,NewTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" NewId,NewTitle,NewContent,NewTime ");
			strSql.Append(" FROM News ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
